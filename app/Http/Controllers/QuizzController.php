...
use App\Repository\Interfaces\QuizzRepositoryInterface as InterfacesQuizzRepositoryInterface;
...
class QuizzController extends Controller
{
    ...
    public function __construct(InterfacesQuizzRepositoryInterface $Quizz)
    {
        $this->Quizz =$Quizz;
    }
